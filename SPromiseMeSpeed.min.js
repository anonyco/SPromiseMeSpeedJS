'use strict';(function(J){function C(e){e()}function D(e){e(this)}function F(){if(v){do q=!1,A.shift()();while(--v)}q=!1}function y(e,k,c){this.then=e;this.catch=k;this.finally=c}function r(e){function k(a){0===f&&(E(a)?a.then(k,c):(g=a,f=2,null!==d&&("function"===typeof d?d(a):d.forEach(D,a),d=null),b=null,null!==l&&("function"===typeof l?l():l.forEach(C),l=null)))}function c(a){0===f&&(g=a,f=1,null!==b&&("function"===typeof b?b(a):b.forEach(D,a),b=null),d=null,null!==l&&("function"===typeof l?
